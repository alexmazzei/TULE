...
; *** (tule-name 	unicode lisp iso-8859-1 utf-8)
   ...
   (left-single-quote   #x2018  #\‘	8216    (226 128 152))
   (right-single-quote  #x2019  #\’	8217    (226 128 153))
   (left-double-quote   #x201C  #\“	8220    (226 128 156))
   (right-double-quote  #x201D  #\”	8221    (226 128 157))
   ...
   (up-alpha            #x0391  #\Α     913     (206 145))
   (up-alpha-acute      #x0386  #\Ά     nil     (206 134))
   (up-beta             #x0392  #\Β     914     (206 146))
   (up-chi              #x03A7  #\Χ     nil     (206 167))
   (up-delta            #x0394  #\Δ     916     (206 148))
   (up-epsilon          #x0395  #\Ε     917     (206 149))
   (up-epsilon-acute    #x0388  #\Έ     904     (206 136))
   (up-eta              #x0397  #\Η     919     (206 151))
   (up-eta-acute        #x0389  #\Ή     905     (206 137))
   (up-gamma            #x0393  #\Γ     915     (206 147))
   (up-iota             #x0399  #\Ι     921     (206 153))
   (up-iota-acute       #x038A  #\Ί     906     (206 138))
   (up-iota-diaer   	#x03AA  nil     nil     (206 170))
   (up-kappa            #x039A  #\Κ     922     (206 154))
   (up-lambda           #x039B  #\Λ     923     (206 155))
   (up-mu               #x039C  #\Μ     924     (206 156))
   (up-nu               #x039D  #\Ν     925     (206 157))
   (up-omega            #x03A9  nil     nil     (206 169))
   (up-omega-acute      #x038F  #\Ώ     911     (206 143))
   (up-omicron          #x039F  nil     nil     (206 159))
   (up-omicron-acute    #x038C  #\Ό     908     (206 140))
   (up-phi              #x03A6  nil     nil     (206 166))
   (up-phi-curled       #x03D5  nil     nil     (207 149))
   (up-pi               #x03A0  #\Π     928     (206 160))
   ...
   (up-upsilon-acute    #x038E  #\Ύ     910     (206 142))
   (up-upsilon-curled   #x03D2  nil     nil     (207 146))
   (up-upsilon-diaer 	#x03AB  nil     nil     (206 171))
   (up-xi               #x039E  #\Ξ     926     (206 158))
   (up-zeta             #x0396  #\Ζ     918     (206 150))
   (greek-apostrophe 	#x0384  #\΄ 	900 	(206 132))
   (greek-mixed-stress 	#x0385  #\΅ 	901 	(206 133))
   (greek-mid-dot 	#x0387  #\· 	903 	(206 135))
