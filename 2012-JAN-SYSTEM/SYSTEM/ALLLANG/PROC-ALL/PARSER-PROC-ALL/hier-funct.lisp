...
; *******************************************************************
; *** the same as the one below, but returns t if up is the same as down
(defun parse-trh-subsumes (up down)
  (or (eq up down) (trh-subsumes up down)))

; *******************************************************************
; *** true if 'up' is an ancestor of 'down' in the hierarchy of subcategorization frames.
