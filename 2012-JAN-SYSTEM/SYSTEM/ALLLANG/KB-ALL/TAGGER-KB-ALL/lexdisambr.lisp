...
(defvar adj-adv-noun-verbr06 nil)	; 
;.....................................
...
(defvar verb-fin-inf-r18-a nil)
(defvar verb-fin-inf-r18-b nil)
(defvar verb-fin-inf-r18-c nil)
(defvar verb-fin-inf-r18-d nil)
(defvar verb-fin-inf-r18-e nil)
(defvar verb-fin-inf-r18bis nil)
...
(defvar verb-imper-ind-r04 nil)
(defvar verb-imper-ind-r05 nil)
;.....................................
...
(setq adj-adv-noun-verbr06		; I left some
   (make-lexdisr
	:if '(and (prevcat 'art)
                  (nextcat '(prep verb)))
	:then 'noun
...
;******************************************************
;*** adj V noun V  predet V pron (default: predet) [TOTS in Catalan]
...
(putrule 'adj-noun-predet-pron 'predet 'defaultc)

;......................................................

;******************************************************
;*** adj V predet V pron (default: predet) [BOTH in English]
...
(putrule 'adj-prep-pron 'adj 'defaultc)
...
(putrule 'verb-aux+pron-main+pron 'aux 'defaultc)
...
(putrule 'verb-fin-inf
         '(verb-fin-inf-r01 verb-fin-inf-r02 verb-fin-inf-r03 verb-fin-inf-r04e verb-fin-inf-r05e
           ...
           verb-fin-inf-r18-a verb-fin-inf-r18-b verb-fin-inf-r18-c verb-fin-inf-r18-d verb-fin-inf-r18-e
           verb-fin-inf-r18bis
           verb-fin-inf-r19 verb-fin-inf-r20 verb-fin-inf-r21e verb-fin-inf-r22e
...
(setq verb-fin-inf-r08ics
   (make-lexdisr
	:if '(and (or (prevcat-agr '(noun (proper nil)) 'verb)
                      (prevchar #\,))
                  (currmood 'participle)
                  (or (not (currperson 'p3))
                      (and (currperson 'p3) (currmood 'ind) (currtense 'rempast)))) ; locazioni concluse
	:then 'inf
	:CF 'U
        :lang '(italian spanish)))
...
(setq verb-fin-inf-r18-b
   (make-lexdisr
	:if '(and (currmood+tense 'participle 'past)
 	          (currmood 'ind)
                  (prevcat-agr 'noun '(verb (mood participle tense past))))
	:then 'inf
	:CF 'U))

; *** if the previous one failed, this applies to non past-part verbs
(setq verb-fin-inf-r18-c
   (make-lexdisr
	:if '(and (currmood+tense 'participle 'past)
 	          (currmood 'ind)
                  (prevcat-agr 'noun 'verb))
	:then 'fin
	:CF 'U))

(setq verb-fin-inf-r18-d
   (make-lexdisr
	:if '(and (prevcat '(conj (type coord)))
                  (currmood+tense 'participle 'past)
 	          (currmood 'ind)
                  (prevverb '(mood participle)))
	:then 'inf
	:CF 'U))

(setq verb-fin-inf-r18-e
   (make-lexdisr
	:if '(and (prevcat '(conj (type coord)))
                  (currmood+tense 'participle 'past)
 	          (currmood 'ind)
                  (prevverb '(mood (imper ind conj condiz))))
	:then 'fin
	:CF 'U))

; poi non successe granchè
(setq verb-fin-inf-r18bis
   (make-lexdisr
	:if '(and (currmood+tense 'participle 'past)
          (currmood 'ind)
...
(putrule 'verb-imper-ind
         '(verb-imper-ind-r01 verb-imper-ind-r02 verb-imper-ind-r03 verb-imper-ind-r04 
           verb-imper-ind-r05)
         'lexdisrules
         '(ind imper))
